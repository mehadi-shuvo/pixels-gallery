(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/components_cards_ImageCard_tsx_30a0278e._.js", {
...
;
;
const ImageCard = ({ src = "/globe.svg", title = "Image Title", views = 500, likes = 44 })=>{
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ImageCard.useEffect": ()=>{
            const handleClickOutside = {
                "ImageCard.useEffect.handleClickOutside": (e)=>{
                    if (modalRef.current && !modalRef.current.contains(e.target)) {
                        setShowModal(false);
                        setZoom(1);
                    }
                }
            }["ImageCard.useEffect.handleClickOutside"];
            if (showModal) {
...
_s(ImageCard, "SFnNl/Kt9ELxd/khZZkYFsF2PVU=");
_c = ImageCard;
...
//# sourceMappingURL=components_cards_ImageCard_tsx_30a0278e._.js.map